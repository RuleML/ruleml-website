...
englishMaxRSVP,englishStartTime,englishEndTime,englishTimeZone,englishStartDate,englishEndDate,englishChannel,englishHour,englishMinute;
...
function createEnglish(){
	...
	(englishStartTime == "any time" && englishEndTime == "any time" ? "any time" : englishStartTime + " to " +englishEndTime) + ", for "  + (englishHour == "0" && englishMinute== "0" ? "any duration" : englishHour + " hour(s) and " + englishMinute + " minute(s)") + ", on " + englishChannel + ".";// + " Time zone should be " + englishTimeZone;
}
