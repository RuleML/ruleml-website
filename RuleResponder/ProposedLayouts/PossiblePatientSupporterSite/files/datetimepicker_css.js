...
var MonthYearColor="#2b3d96";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#003cff";//var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor="#7293ff";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#7293ff";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#FFFF33";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#003cff";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#2b3d96";//color of font of Year selector.
var MthSelColor="#2b3d96";//color of font of Month selector if "MonthSelector" is "arrow".
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	funcCalback+="elementSelectedStartDate();elementSelectedEndDate();\n}\n";
