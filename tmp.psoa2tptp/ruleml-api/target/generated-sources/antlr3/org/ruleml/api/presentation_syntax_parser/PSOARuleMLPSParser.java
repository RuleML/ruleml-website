// $ANTLR 3.4 org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g 2012-07-09 15:58:59
...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "queries"
    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:65:1: queries : ( rule )+ ;
    public final PSOARuleMLPSParser.queries_return queries() throws RecognitionException {
        PSOARuleMLPSParser.queries_return retval = new PSOARuleMLPSParser.queries_return();
        retval.start = input.LT(1);


        CommonTree root_0 = null;

        PSOARuleMLPSParser.rule_return rule3 =null;



        try {
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:66:5: ( ( rule )+ )
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:66:9: ( rule )+
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    public final PSOARuleMLPSParser.document_return document() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: prefix, base, group, importDecl, DOCUMENT
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // $ANTLR start "rule"
    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:94:1: rule : ( FORALL ( VAR_ID )+ LPAR clause RPAR -> ^( FORALL ^( VAR_LIST ( VAR_ID )+ ) clause ) | clause );
    public final PSOARuleMLPSParser.rule_return rule() throws RecognitionException {
        ...
        try {
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:95:5: ( FORALL ( VAR_ID )+ LPAR clause RPAR -> ^( FORALL ^( VAR_LIST ( VAR_ID )+ ) clause ) | clause )
            int alt11=2;
            switch ( input.LA(1) ) {
            case FORALL:
                {
            ...
            switch (alt11) {
                case 1 :
                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:95:9: FORALL ( VAR_ID )+ LPAR clause RPAR
                    {
                    FORALL29=(Token)match(input,FORALL,FOLLOW_FORALL_in_rule440);  
                    stream_FORALL.add(FORALL29);


                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:95:16: ( VAR_ID )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    {
                        // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:96:12: ^( FORALL ^( VAR_LIST ( VAR_ID )+ ) clause )
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                        ...
                        // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:96:21: ^( VAR_LIST ( VAR_ID )+ )
                        {
    ...
    // $ANTLR start "clause"
    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:100:1: clause : f1= formula ( IMPLICATION f2= formula )? -> {isRule}? ^( IMPLICATION $f1 $f2) -> $f1;
    public final PSOARuleMLPSParser.clause_return clause() throws RecognitionException {
        ...
        try {
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:114:5: (f1= formula ( IMPLICATION f2= formula )? -> {isRule}? ^( IMPLICATION $f1 $f2) -> $f1)
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:114:9: f1= formula ( IMPLICATION f2= formula )?
            {
            ...
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:114:20: ( IMPLICATION f2= formula )?
            int alt12=2;
            switch ( input.LA(1) ) {
                case IMPLICATION:
                    {
            ...
            switch (alt12) {
                case 1 :
                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:114:22: IMPLICATION f2= formula
                    {
            ...
            if (isRule) {
                // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:115:18: ^( IMPLICATION $f1 $f2)
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
    ...
    // $ANTLR start "formula"
    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:119:1: formula returns [boolean isValidHead, boolean isAtomic] : ( AND LPAR (f= formula )+ RPAR -> ^( AND ( formula )* ) | OR LPAR ( formula )+ RPAR -> ^( OR ( formula )* ) | EXISTS ( VAR_ID )+ LPAR f= formula RPAR -> ^( EXISTS ^( VAR_LIST ( VAR_ID )+ ) $f) | atomic -> atomic | ( external_term -> external_term ) ( psoa_rest -> ^( PSOA $formula psoa_rest ) )? );
    public final PSOARuleMLPSParser.formula_return formula() throws RecognitionException {
        ...
        try {
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:121:5: ( AND LPAR (f= formula )+ RPAR -> ^( AND ( formula )* ) | OR LPAR ( formula )+ RPAR -> ^( OR ( formula )* ) | EXISTS ( VAR_ID )+ LPAR f= formula RPAR -> ^( EXISTS ^( VAR_LIST ( VAR_ID )+ ) $f) | atomic -> atomic | ( external_term -> external_term ) ( psoa_rest -> ^( PSOA $formula psoa_rest ) )? )
            int alt17=5;
            switch ( input.LA(1) ) {
            case AND:
                {
            ...
            switch (alt17) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:123:9: EXISTS ( VAR_ID )+ LPAR f= formula RPAR
                    {
                    EXISTS43=(Token)match(input,EXISTS,FOLLOW_EXISTS_in_formula656);  
                    stream_EXISTS.add(EXISTS43);


                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:123:16: ( VAR_ID )+
                    int cnt15=0;
                    loop15:
                    do {
                        int alt15=2;
                    ...
                    {
                        // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:124:12: ^( EXISTS ^( VAR_LIST ( VAR_ID )+ ) $f)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        root_1 = (CommonTree)adaptor.becomeRoot(
                        ...
                        // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:124:21: ^( VAR_LIST ( VAR_ID )+ )
                        {
                        CommonTree root_2 = (CommonTree)adaptor.nil();
                        root_2 = (CommonTree)adaptor.becomeRoot(
                        (CommonTree)adaptor.create(VAR_LIST, "VAR_LIST")
    ...
    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:144:1: simple_term : ( constant | VAR_ID );
    public final PSOARuleMLPSParser.simple_term_return simple_term() throws RecognitionException {
        ...
        try {
            // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:145:5: ( constant | VAR_ID )
            int alt20=2;
            switch ( input.LA(1) ) {
            case CURIE:
            case ID:
            ...
            switch (alt20) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // org/ruleml/api/presentation_syntax_parser/PSOARuleMLPS.g:146:9: VAR_ID
                    {
                    root_0 = (CommonTree)adaptor.nil();
    ...
    public final PSOARuleMLPSParser.external_term_return external_term() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: simple_term, term, EXTERNAL
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt34) {
                ...
                case 6 :
                    ...
                    TOP86=(Token)match(input,TOP,FOLLOW_TOP_in_constant1420); 
                    TOP86_tree = 
    ...
    public final PSOARuleMLPSParser.const_string_return const_string() throws RecognitionException {
        ...
        try {
            ...
            {
            STRING87=(Token)match(input,STRING,FOLLOW_STRING_in_const_string1445);  
            ...
            switch (alt36) {
                case 1 :
                    ...
                    {
                    SYMSPACE_OPER88=(Token)match(input,SYMSPACE_OPER,FOLLOW_SYMSPACE_OPER_in_const_string1449);  
                    ...
                    switch (alt35) {
                        case 1 :
                            ...
                            {
                            IRI_REF89=(Token)match(input,IRI_REF,FOLLOW_IRI_REF_in_const_string1454);  
                        ...
                        case 2 :
                            ...
                            {
                            CURIE90=(Token)match(input,CURIE,FOLLOW_CURIE_in_const_string1458);  
                ...
                case 2 :
                    ...
                    {
                    char_literal91=(Token)match(input,51,FOLLOW_51_in_const_string1467);  
    ...
    public static final BitSet FOLLOW_rule_in_queries183 = new BitSet(new long[]{0x0001480C0404E0A2L});
    ...
    public static final BitSet FOLLOW_LPAR_in_group378 = new BitSet(new long[]{0x0001484C0406E0A0L});
    public static final BitSet FOLLOW_group_element_in_group380 = new BitSet(new long[]{0x0001484C0406E0A0L});
    ...
    public static final BitSet FOLLOW_FORALL_in_rule440 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_VAR_ID_in_rule442 = new BitSet(new long[]{0x0001000080000000L});
    public static final BitSet FOLLOW_LPAR_in_rule445 = new BitSet(new long[]{0x0001480C040460A0L});
    ...
    public static final BitSet FOLLOW_IMPLICATION_in_clause521 = new BitSet(new long[]{0x0001480C040460A0L});
    ...
    public static final BitSet FOLLOW_LPAR_in_formula597 = new BitSet(new long[]{0x0001480C040460A0L});
    public static final BitSet FOLLOW_formula_in_formula602 = new BitSet(new long[]{0x0001484C040460A0L});
    ...
    public static final BitSet FOLLOW_LPAR_in_formula630 = new BitSet(new long[]{0x0001480C040460A0L});
    public static final BitSet FOLLOW_formula_in_formula632 = new BitSet(new long[]{0x0001484C040460A0L});
    public static final BitSet FOLLOW_RPAR_in_formula635 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EXISTS_in_formula656 = new BitSet(new long[]{0x0001000000000000L});
    public static final BitSet FOLLOW_VAR_ID_in_formula658 = new BitSet(new long[]{0x0001000080000000L});
    public static final BitSet FOLLOW_LPAR_in_formula661 = new BitSet(new long[]{0x0001480C040460A0L});
    ...
    public static final BitSet FOLLOW_set_in_atomic786 = new BitSet(new long[]{0x0001480404044080L});
    ...
    public static final BitSet FOLLOW_LPAR_in_external_term884 = new BitSet(new long[]{0x0001480404040080L});
    public static final BitSet FOLLOW_simple_term_in_external_term886 = new BitSet(new long[]{0x0000000080000000L});
    public static final BitSet FOLLOW_LPAR_in_external_term888 = new BitSet(new long[]{0x0001484404044080L});
    public static final BitSet FOLLOW_term_in_external_term890 = new BitSet(new long[]{0x0001484404044080L});
    ...
    public static final BitSet FOLLOW_LPAR_in_internal_term967 = new BitSet(new long[]{0x0001484504044080L});
    ...
    public static final BitSet FOLLOW_INSTANCE_in_psoa_rest1046 = new BitSet(new long[]{0x0001480404040080L});
    public static final BitSet FOLLOW_simple_term_in_psoa_rest1048 = new BitSet(new long[]{0x0000000080000002L});
    public static final BitSet FOLLOW_LPAR_in_psoa_rest1051 = new BitSet(new long[]{0x0001484504044080L});
    ...
    public static final BitSet FOLLOW_tuple_in_tuples_and_slots1092 = new BitSet(new long[]{0x0001480504044082L});
    public static final BitSet FOLLOW_slot_in_tuples_and_slots1095 = new BitSet(new long[]{0x0001480404044082L});
    public static final BitSet FOLLOW_term_in_tuples_and_slots1116 = new BitSet(new long[]{0x00014C0404044082L});
    public static final BitSet FOLLOW_SLOT_ARROW_in_tuples_and_slots1130 = new BitSet(new long[]{0x0001480404044080L});
    public static final BitSet FOLLOW_term_in_tuples_and_slots1134 = new BitSet(new long[]{0x0001480404044082L});
    public static final BitSet FOLLOW_slot_in_tuples_and_slots1138 = new BitSet(new long[]{0x0001480404044082L});
    public static final BitSet FOLLOW_LSQBR_in_tuple1233 = new BitSet(new long[]{0x0001480404044080L});
    public static final BitSet FOLLOW_term_in_tuple1235 = new BitSet(new long[]{0x0001488404044080L});
    ...
    public static final BitSet FOLLOW_SLOT_ARROW_in_slot1276 = new BitSet(new long[]{0x0001480404044080L});
    ...
    public static final BitSet FOLLOW_TOP_in_constant1420 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_const_string1445 = new BitSet(new long[]{0x0008200000000002L});
    public static final BitSet FOLLOW_SYMSPACE_OPER_in_const_string1449 = new BitSet(new long[]{0x0000000004000080L});
    public static final BitSet FOLLOW_IRI_REF_in_const_string1454 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CURIE_in_const_string1458 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_51_in_const_string1467 = new BitSet(new long[]{0x0000000000000002L});
